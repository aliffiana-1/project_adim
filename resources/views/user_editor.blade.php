    ...
    <div class="container py-5">
                ...
                <tbody class="text-uppercase">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="fa fa-edit text-warning" data-bs-toggle="modal" data-bs-target="#EditModal-{{ $data->id_user }}"></a>
                        </td>
                        <td class="text-center">
                            <a class="far fa-trash-alt text-danger" data-bs-toggle="modal" data-bs-target="#DeleteModal-{{ $data->id_user }}"></a>
                        </td>
                    </tr>

                    <div class="modal fade" id="EditModal-{{ $data->id_user }}" tabindex="-1">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-floating mb-2">
                                            <select name="id_role" class="form-control" required>
                                                @foreach($roles as $r)
                                                <option value="{{ $r->id_role }}" {{ $data->id_role == $r->id_role ? 'selected' : '' }}>
                                                    {{ $r->role_name }}
                                                </option>
                                                @endforeach
                                            </select>
                    ...
                    {{-- DELETE MODAL --}}
                    <div class="modal fade" id="DeleteModal-{{ $data->id_user }}" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="col d-flex flex-column" id="showing_page">
                Showing
                {!! $user_data->firstItem() !!} to
                {!! $user_data->lastItem() !!} of {!! $user_data->total() !!} entries
            </div>
            <div class="col-md-6 d-flex flex-column align-items-md-end" id="showing_page">
                {!! $user_data->appends(request()->all())->links() !!}
            </div>
        </div>
    </div>
</div>
